...
import { type OrderStatus, type OrderItemStatus, UserRole } from "@prisma/client"
...
export class OrdersController {
  ...
  updateItemStatus(@Param('id') id: string, @Param('itemId') itemId: string, @Body('status') status: OrderItemStatus) {
